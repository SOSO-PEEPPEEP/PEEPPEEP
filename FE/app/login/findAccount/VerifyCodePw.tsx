  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contents}>
        ...
        <TextInput style={styles.inputBox} placeholder="인증번호 6자리 숫자 입력" value={verificationCode} onChangeText={setverificationCode} placeholderTextColor="#d3d3dd" underlineColorAndroid="transparent" keyboardType="numeric"></TextInput>
        {errorMsg && (
