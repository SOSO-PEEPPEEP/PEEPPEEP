                ...
                <TouchableOpacity onPress={pickImage} activeOpacity={0.8}>
                    ...
                    {imageUri?(
                      ...
                      />
                        ...
                        <View>
                            <Image source={require('@/assets/images/Add_Daily_Image_dark.png')} style={{position:'absolute',width:60, height:60,left:-1,top:-1}}/>
                            <Image source={require('@/assets/images/Add_Daily_Image_white.png')} style={{width:60, height:60}}/>
                        </View>
